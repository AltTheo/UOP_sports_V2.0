...
import 'package:sport_test/component/service_grid.dart';

import 'gym_booking_calendar.dart';
    ...
    return Scaffold(
        ...
        body: GridView(
            ...
            children: [
              // BOOKING CARD
              Servicegrid(
                  gridImage: Image.asset('lib/assets/images/gym_lifting.png',
                      height: 110, gaplessPlayback: true, fit: BoxFit.fill),
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => const GymBookingCalendarView()));
                    // var url = Uri.parse(
              ...
              //CLASSES CARD
              Servicegrid(
                  gridImage: Image.asset('lib/assets/images/Gym_booking.png',
                      height: 110, gaplessPlayback: true, fit: BoxFit.fill),
                  onTap: () {},
              ...
              //RULES CARD
              Servicegrid(
                  gridImage: Image.asset('lib/assets/images/gym_services.png',
                      height: 110, gaplessPlayback: true, fit: BoxFit.fill),
                  onTap: () {},
                  gridtitle: 'Gym rules')
