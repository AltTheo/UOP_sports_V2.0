...
class ClassBookingCalendarView extends StatefulWidget {
  const ClassBookingCalendarView({Key? key}) : super(key: key);

  @override
  State<ClassBookingCalendarView> createState() =>
      _ClassBookingCalendarViewState();
}

class _ClassBookingCalendarViewState extends State<ClassBookingCalendarView> {
